...
import { FaLinkedin, FaGithubAlt, FaInstagram, FaFacebook, FaEnvelope, FaMobileAlt } from "react-icons/fa"
...
export default {
    socialIcons: [
        ...
        },
        {
            id: 4,
            icon: <FaFacebook />,
            link: 'https://www.facebook.com/brianevans99',
            anchor: 'text-blue-800 hover:text-blue-900'
        }
    ],
    contactInfo: [
        {
